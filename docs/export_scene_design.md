...
*   A dedicated CLI argument when running `theatre.py` (e.g., `python src/renderer/theatre.py --export-scene assets/story/scene_sailboat.json --duration 5 --output output.mp4`).
