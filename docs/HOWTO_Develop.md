...
cd ..
rm -rf papeterie-pythonAnywhere # or whatever your folder is named

# 2. Shallow Clone (Depth 1 = No History, fast & small)
git clone --depth 1 https://github.com/charojo/papeterie-engine.git papeterie-pythonAnywhere
cd papeterie-pythonAnywhere
